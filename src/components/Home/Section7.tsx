      ...
      >
        ...
        >
          ...
          >
            ...
            وعالي الدهون، لديه القدرة على تغيير جسمك بطرق لا يستطيع أي نظام
            غذائي آخر القيام بها.
          </Text>
          <Text
            my='3'
            fontSize={{ base: '15px', md: '20.5px' }}
            color='orange.900'
          >
            إنه يضع جسمك في الكيتوزية، الحالة المعززة للصحة حيث تحرق الدهون
            للحصول على الطاقة.
          </Text>
